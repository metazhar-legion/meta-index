...
contract TestBaseVault is BaseVault {
    constructor(IERC20 asset_, IFeeManager feeManager_) BaseVault(asset_, feeManager_) {}
}
...
contract BaseVaultTest is Test {
    ...
    function test_Withdraw() public {
        ...
        assertEq(
            ...
            INITIAL_BALANCE - DEPOSIT_AMOUNT + withdrawAmount,
            "USDC should be transferred to user"
        );
