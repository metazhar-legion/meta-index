...
contract UniswapV3AdapterTest is Test {
    ...
    function test_Swap_USDC_to_WETH() public {
        ...
        // Execute the swap
        uint256 amountOut = adapter.swap(address(usdc), address(weth), amountIn, minAmountOut, user1);
    ...
    function test_Swap_USDC_to_WBTC() public {
        ...
        // Execute the swap
        uint256 amountOut = adapter.swap(address(usdc), address(wbtc), amountIn, minAmountOut, user1);
    ...
    function test_Swap_WETH_to_WBTC() public {
        ...
        // Execute the swap
        uint256 amountOut = adapter.swap(address(weth), address(wbtc), amountIn, minAmountOut, user1);
    ...
    function test_Swap_To_Different_Recipient() public {
        ...
        uint256 amountOut = adapter.swap(address(usdc), address(weth), amountIn, minAmountOut, user2);
    ...
    function test_Swap_Unsupported_Pair() public {
        ...
        vm.expectRevert();
        adapter.swap(address(usdc), address(unsupportedToken), amountIn, 0, user1);
    ...
    function test_Swap_Zero_Amount() public {
        ...
        vm.expectRevert();
        adapter.swap(address(usdc), address(weth), 0, 0, user1);
    ...
    function test_Swap_Same_Token() public {
        ...
        vm.expectRevert();
        adapter.swap(address(usdc), address(usdc), amountIn, 0, user1);
    ...
    function test_Swap_Zero_Address_Recipient() public {
        ...
        vm.expectRevert();
        adapter.swap(address(usdc), address(weth), amountIn, 0, address(0));
