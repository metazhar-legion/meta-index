...
contract CapitalAllocationManager is ICapitalAllocationManager, Ownable, ReentrancyGuard {
     ...
     */
    function addYieldStrategy(address strategy, uint256 percentage)
        external
        override
        onlyOwner
        returns (bool success)
    {
        ...
        // Add strategy
        yieldStrategies.push(StrategyAllocation({strategy: strategy, percentage: percentage, active: true}));
     ...
     */
    function updateYieldStrategy(address strategy, uint256 percentage)
        external
        override
        onlyOwner
        returns (bool success)
    ...
    function addRWAToken(address rwaToken, uint256 percentage) external override onlyOwner returns (bool success) {
        ...
        // Add RWA token
        rwaTokens.push(RWAAllocation({rwaToken: rwaToken, percentage: percentage, active: true}));
